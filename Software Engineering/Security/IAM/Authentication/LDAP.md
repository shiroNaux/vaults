...
LDAP là viết tắt của Lightweight Directory Access Protocol -> Nó là 1 Giao thức (Protocol) dùng để lấy thông tin được lưu trữ dưới dạng các directory thông qua network.
