...
7. Consumer 
	...
	***Làm thế nào để ứng dụng sau khi restart kafka vẫn nhận ra đó là service nào và apply offset cũ ???***
	***How Kafka distinct consumer & producer ???***
	

### [[Kafka Connect]]
- Ecosystem of pluggable
- Client application -> not run on brokers
- Declerative bằng [[JSON]] để config. Ví dụ:
